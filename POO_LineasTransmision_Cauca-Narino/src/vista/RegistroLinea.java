...
public class RegistroLinea extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Capacidad capacidad;
        Subestacion subestacionUbicacion=null;
        ...
        try {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Por favor ingrese una fecha válida y completa en formato DÍA/MES/AÑO", "Fecha Inválida", javax.swing.JOptionPane.WARNING_MESSAGE);
        ...
        try {
            ...
            limiteTermico = (Math.sqrt(3) * voltajeSeleccionado * corrienteDigitada * 0.9) / 1000.0;
            ...
            for(Subestacion subestacion : controladorSubestacion.obtenerSubestaciones()){
                if(subestacion.getNombre().equalsIgnoreCase(subestacionOrigen)){
                    subestacionUbicacion=subestacion;
                }
            }
            
            //si la subestacion existe se hace la instanciacion de la ubicacion 
            if(subestacionUbicacion!=null){
                ubicacion = new Ubicacion(subestacionUbicacion.getUbicacion().getDepartamento(), subestacionUbicacion.getUbicacion().getMunicipio(), subestacionUbicacion.getUbicacion().getSubAreaOperativa());
            }
            ...
            capacidad = new Capacidad(voltajeSeleccionado, voltajeMaximo, corrienteDigitada, corrienteEmergencia, limiteTermico, 0.0);
