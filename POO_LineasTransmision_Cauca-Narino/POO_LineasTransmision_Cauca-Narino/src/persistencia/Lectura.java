    ...
    public void lecturaLineasDeTransmision() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(in))){
            ...
            while ((s = br.readLine()) != null) {
                ...
                InformacionBasica informacionBasica = new InformacionBasica(token[0],token[1], token[2], token[3], token[4], token[5], subestacionesRelacionadas, token[7], token[8]);
    ...
    public void lecturaSubestaciones(){
        ...
        try(BufferedReader br = new BufferedReader(new FileReader(in))){
            ...
            while((s=br.readLine())!=null){
                ...
                Subestacion subestacion = new Subestacion(token[0], token[1], voltajesNominales, operadores, ubicacion, Double.parseDouble(token[7]), Double.parseDouble(token[8]));
